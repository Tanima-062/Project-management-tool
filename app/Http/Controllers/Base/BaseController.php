...
use App\Mixins\ControllerMixins\ProtectedBaseController;
use Exception;
    ...
    public function __construct()
    {
        ...
        if (method_exists($this->entityInstance, 'serializerFields')) {
            if (method_exists($this->entityInstance, 'detailsViewSerializer')) {
                BaseResource::serializerFieldsSet($this->entityInstance->detailsViewSerializer());
            } else {
                BaseResource::serializerFieldsSet($this->entityInstance->serializerFields());
            }
            BaseCollection::serializerFieldsSet($this->entityInstance->serializerFields());
        }
    }
