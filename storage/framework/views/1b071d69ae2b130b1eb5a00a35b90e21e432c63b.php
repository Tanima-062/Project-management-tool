                ...
                <div class="CreateTaskBox card-body">
                    ...
                    <div class="row assign-by-assign-to-block">
                        <div class="col-md-6 pl-0">
                            ...
                            <br>
                            <?php if(isset($task->start_date) && isset($task->end_date)): ?>
                                ...
                                <div class="row date-row">
                                    <div class="col-6">
                                        <div class="task-element">
                                            ...
                                            <br>
                                            <i class="fa fa-clock"><span><?php echo e(sprintf('%02d:%02d', (int) $task->allocated_time, fmod($task->allocated_time, 1) * 60)); ?></span></i>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>                           
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <select class="progress-dropdown" name="task_status">
                                            <!-- <option value="0" <?php echo e(($my_task_status == 0) ? 'selected' : ''); ?>>Accepted</option> -->
