...
<body>
<iframe src="<?php echo e($banner->background_link); ?>" frameborder="0" scrolling="no" width="160" height="600" id="showHideIframe"></iframe>
...
include('https://bikroyit.com/assets/js/jStorage.js', function() {
    include('https://cdn.jsdelivr.net/npm/moment@2.24.0/moment.min.js',function(){
        ...
        if(bikroy_ad_data.no_of_show > ad_visibility_limit){
            ...
            // skinBaner.style.backgroundColor = <?php echo json_encode($banner->background_color); ?>;
            ...
            var interval = setInterval(function () {
                sec++;
                console.log(<?php echo json_encode($banner->start_time) + json_encode($banner->end_time); ?>);
                if(sec > <?php echo json_encode($banner->start_time) + json_encode($banner->end_time); ?>){
