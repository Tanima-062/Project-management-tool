...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" autocomplete="nope">
...
unset($__errorArgs, $__bag); ?>" id="designation" value="<?php echo e(old('designation')); ?>" name="designation">
...
unset($__errorArgs, $__bag); ?> col-md-12 dropdownField" name="supervisor">
                                            ...
                                            <?php $__currentLoopData = $supervisors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supervisor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($supervisor->id); ?>" <?php echo e((old('supervisor') == $supervisor->id) ? 'selected' : ''); ?>><?php echo e($supervisor->name . ' (' . $supervisor->email . ')'); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" value="<?php echo e(old('password')); ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" autocomplete="new-password">
...
unset($__errorArgs, $__bag); ?>" id="phone_number" name="phone_number" value="<?php echo e(old('phone_number')); ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control <?php echo e($errors->has('programs') ? ' is-invalid' : ''); ?> col-md-12 select2" name="programs[]" id="programs" multiple>
                                            <?php $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($program->id); ?>" <?php echo e((collect(old('programs'))->contains($program->id)) ? 'selected':''); ?>><?php echo e($program->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
unset($__errorArgs, $__bag); ?> col-md-12 dropdownField" name="team">
                                            ...
                                            <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                               <option value="<?php echo e($team->id); ?>" <?php echo e((old('team') == $team->id) ? 'selected' : ''); ?>><?php echo e($team->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="custom-file">
                                            <input type="file" class="form-control custom-file-input <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="customFileLang" lang="es" name="image" value="<?php echo e(old('image')); ?>">
...
<?php /**PATH C:\xampp\htdocs\project_management_tool\resources\views/backend/users/create.blade.php ENDPATH**/ ?>