    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel task-index-panel" >
            <div class="content-wrapper py-4">
                ...
                <form id="searchForm" method="POST" action="<?php echo e(route('myRequestTask.search')); ?>">
                    <?php echo csrf_field(); ?>
                ...
                <div class="row DataTableBox" style="margin-top: 20px; padding-bottom:20px;" id="taskSearchBox">
                    <div>
                        <div class="form-inline row task-search-box m-0 py-3" style="border-bottom: 2px solid rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="col-6 px-0" style="text-align: right;">
                                <a href="<?php echo e(route('myRequestTasks.export')); ?>" class="task-export">
                    ...
                    <div id="task_table" class="task-table">
                        <?php echo $__env->make('backend.my_request_tasks.task_table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/bikroy/public_html/project_management_tool/resources/views/backend/my_request_tasks/list.blade.php ENDPATH**/ ?>