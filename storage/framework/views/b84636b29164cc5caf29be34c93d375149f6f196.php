...
<body>
<iframe src="https://bikroyit.com/html_banner/airtel_robi_2021/970x90.html" frameborder="0" scrolling="no" width="970" height="90" id="showHideIframe" style="display:none;"></iframe>
...
include('https://bikroyit.com/assets/js/jStorage.js', function() {
    include('https://cdn.jsdelivr.net/npm/moment@2.24.0/moment.min.js',function(){
        ...
        let ad_id  = 1;
        let ad_visibility_limit = 2000000;
        if(!bikroy_ad_data){
            let ad_data = {
        ...
        if(bikroy_ad_data.no_of_show > ad_visibility_limit){
            ...
            var mainBannerWidth = '160';									                        //main banner width
            var mainBannerHeight = '600';									                        //main banner height
