...
<body>
<iframe src="<?php echo e($banner->background_link); ?>" frameborder="0" scrolling="no" width="250" height="250" id="showHideIframe"></iframe>
...
include('https://bikroyit.com/assets/js/jStorage.js', function() {
    include('https://cdn.jsdelivr.net/npm/moment@2.24.0/moment.min.js',function(){
        let ad_var_name = 'bikroy-airtel-mobile';
        let bikroy_ad_data = $.jStorage.get(ad_var_name);
        let ad_id  = 1;
        let ad_visibility_limit = 20000000;
        if(!bikroy_ad_data){
            let ad_data = {
        ...
        if(bikroy_ad_data.no_of_show > ad_visibility_limit){
            ...
            //config
            var base_url = <?php echo json_encode($banner->link); ?>;
            //var base_url = '';
...
//----------------------------------------Don't edit beyond here--------------------------------------------------------
            ...
            closeButton.href='#';
            closeButton.setAttribute('style',"display:block;width:28px;position:absolute;top:7px;right:7px")
            ...
            logo.setAttribute('style',"width:135px;top:10px;position:absolute;left:7px");

            var top_bar = document.createElement('div');
            top_bar.setAttribute('style',"width:100%;height:45px;position:fixed;left:0;top:0;background:#009877;z-index:10")
            ...
            // skinBannerHolder.style.backgroundColor = <?php echo json_encode($banner->background_color); ?>;
            ...
            var interval = setInterval(function () {
                ...
                if(sec > <?php echo json_encode($banner->end_time); ?>){
                    ...
                    closeIFrame();
                    clearInterval(interval)
                }else if(sec == <?php echo json_encode($banner->start_time); ?>){
