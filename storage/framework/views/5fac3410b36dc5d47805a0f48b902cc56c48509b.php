        ...
        <div class="container">
            ...
            <div class="row login-first-row">
                <div class="col-lg-6 left-item">
                        <img src="<?php echo e(asset('backend/assets/img/Login_Page_Vector_Graphics.png')); ?>" class="Login-Page-Vector-Graphics img-fluid">
                </div>
                        ...
                        <div class="card-body login-card-body">
                            ...
                            <form method="POST" action="<?php echo e(route('login.submit')); ?>">
                                ...
                                <div class="input-group mb-3">
                                    <img src="<?php echo e(asset('backend/assets/img/stl_user_icon.png')); ?>"
                                         class="User-Icon">
...
<?php /**PATH C:\xampp\htdocs\banner_project\resources\views/backend/auth/login.blade.php ENDPATH**/ ?>