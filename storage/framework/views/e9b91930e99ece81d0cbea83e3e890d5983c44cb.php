                        ...
                        <div class="form-group row start-end-priority">
                            <div class="col-sm-4">
                                ...
                                <div class='right-inner-addon date datepicker'>
                                    ...
                                    <input name='start_date' value="<?php echo e(isset($task->start_date) ? date('d M, Y', strtotime($task->start_date)) : ''); ?>" data-date="" data-date-format="d M, yyyy" type="text" class="form-control date-picker" id="start_date" autocomplete="off" readonly/>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class='right-inner-addon date datepicker'>
                                    <i class="fa fa-calendar-o date-picker"></i>
                                    <input name='end_date' value="<?php echo e(isset($task->end_date) ? date('d M, Y', strtotime($task->end_date)) : ''); ?>" data-date="" data-date-format="d M, yyyy" type="text" class="form-control date-picker" id="end_date" autocomplete="off" readonly/>
                                </div>
