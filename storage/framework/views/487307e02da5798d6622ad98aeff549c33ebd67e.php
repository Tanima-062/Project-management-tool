                            ...
                            <form method="POST" action="<?php echo e(route('worklogs.update')); ?>"> 
                                ...
                                <table class="table">
                                    <tr class="row-copy" style="display:none;">
                                        ...
                                        <td>
                                            <textarea name="summery[]" rows="5" cols="40"><?php echo e(old('summery')); ?></textarea>
                                        </td>
                                        <td>
                                        ...
                                        <?php $__currentLoopData = $work_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $worklog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="existing-tasks">
                                                ...
                                                <td>
                                                    <div class='right-inner-addon date datepicker'>
                                                        <i class="fa fa-calendar-o date-picker" style="margin-top:7px;"></i>
                                                        <input name='dates[]' value="<?php echo e(date('d M, Y',strtotime($worklog->date))); ?>" type="text" class="form-control date-picker date-picker-input" data-date="" data-date-format="d M, yyyy" autocomplete="off" readonly id="date"/>
                                                    </div>
                                                </td>
                                                <td>
                                                    <textarea name="summery[]" rows="5" cols="40"><?php echo e($worklog->summery); ?></textarea>
                                                </td>
                                                <td>
                                                    <div class="w3-container">
