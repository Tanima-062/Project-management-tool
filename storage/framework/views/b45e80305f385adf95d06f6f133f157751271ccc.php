...
<?php if(!empty($creative_details) && $creative_details->is_active == 1 && $creative_details->creative != ''): ?>
    <?php if(is_image($creative_details->creative)): ?>
        <img id="campaign_ad" src="<?php echo URL::asset('public/uploads/images/'.$creative_details->creative); ?>" alt="" style="width:320px;height:250px">
    <?php else: ?>
                                                ...
                                                <figcaption>
                                                    ...
                                                    <div class="row price_details">
                                                        <div class="col-xs-12">
                                                            ...
                                                            <p class="prev_price text-muted">TK <?php echo number_format($content->discounted_price); ?></p>
                                                            <?php endif; ?>
