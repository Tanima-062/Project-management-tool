    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel role-edit-main-panel">
            <div class="content-wrapper">
                ...
                <h3 class="role-edit-title">Tag</h3>
                <hr class="Dash-Line">
                <div class="CreateRolekBox card-body">
                    <h5 class="mb-4 mt-2">Edit Tag - <?php echo e($tag->name); ?></h5>
                    <hr>
                        ...
                        <form action="<?php echo e(route('tags.update',$tag->id)); ?>" method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-center">
                                    <a href="<?php echo e(route('tags.index')); ?>" class="btn custom-outline-btn">Cancel</a>
...
<?php /**PATH C:\xampp\htdocs\project_management_tool\resources\views/backend/tags/edit.blade.php ENDPATH**/ ?>