...
<?php if(!empty($creative_details) && $creative_details->is_active == 1 && $creative_details->creative != ''): ?>
    <?php if(is_image($creative_details->creative)): ?>
        <img id="campaign_ad" src="<?php echo URL::asset('public/uploads/images/'.$creative_details->creative); ?>" alt="" style="width:250px;height:auto">
    <?php else: ?>
        <iframe id="campaign_ad" src="<?php echo URL::asset('public/uploads/'.$creative_details->creative); ?>" frameborder="0" scrolling="no" width="320" height="250"></iframe>
    <?php endif; ?>
<?php endif; ?>
                ...
                <div class="row">
                    <div class="col-xs-12 header_section">
                        <a href="<?php echo site_urls()['deals']; ?>" target="_blank">
                            <img  src="<?php echo URL::asset('resources/views/admin/modules/deals/prev_v2/assets/250x250/deals.png'); ?>" alt="" class="pull-left deals_image">
                        </a>
                        <a href="<?php echo site_urls()['deals']; ?>" target="_blank">
                            <img src="<?php echo URL::asset('resources/views/admin/modules/deals/prev_v2/assets/250x250/buy-now.png'); ?>" alt="" class="pull-right buy_now_img">
                        </a>
                    </div>
                </div>
                <div class="row">
                                ...
                                <a href="<?php echo $content->link.$deal->utm; ?>" target="_blank">
                                    <div class="slide">
                                        <?php if($content->discount != null): ?>
                                            ...
                                            <figure>
                                                <div class="img_box">
                                                    <img src="<?php echo generate_custom_image($content->image,'100/100','cropped'); ?>" alt="" class="img-responsive text-center" />
                                                </div>
                                                <figcaption>
