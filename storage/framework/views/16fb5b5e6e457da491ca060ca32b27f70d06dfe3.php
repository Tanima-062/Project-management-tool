                        ...
                        <div class="row" style="margin-top: 20px;">
                            ...
                            <?php $__currentLoopData = $task->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    ...
                                    <a href="<?php echo e(route('request.file.download',['taskId' => $task->id])); ?>"><?php echo e(empty($attachment->file_name) ? '' : $attachment->file_name); ?></a>
                                </div>
                                                                ...
                                                                <?php if(count($reply->attachments) > 0): ?>
                                                                    <?php $__currentLoopData = $reply->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <div class="hand-icon-added">
                                                                            <!-- <input type="checkbox" disabled> -->
                                                                            <i class="fas fa-hand-point-right"></i>
                                                                            <a href="<?php echo e(route('requestTask.download.replyFile',['replyId' => $reply->id])); ?>"><?php echo e(empty($attachment->file_name) ? '' : $attachment->file_name); ?></a>
                                                                        </div>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php endif; ?>
...
<?php /**PATH /home/bikroy/public_html/project_management_tool/resources/views/backend/other_request_tasks/view.blade.php ENDPATH**/ ?>