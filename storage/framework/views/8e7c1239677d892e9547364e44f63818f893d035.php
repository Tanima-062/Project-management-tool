                ...
                <div class="row DataTableBox">
                    <div class="row role-list-table-subHeader">
                        ...
                        <div class="col-sm-7 subHeader-col-2">
                            <?php if(\App\Modals\User::hasSpecificPermission(\Illuminate\Support\Facades\Auth::user(),'company.create')): ?>
                            ...
                            <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(isset($unit)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(\App\Modals\User::hasSpecificPermission(\Illuminate\Support\Facades\Auth::user(),'company.edit')): ?>
                                               <a class="Rectangle-Edit btn-hover2" style="text-decoration: none;" href="<?php echo e(route('companys.edit', $unit->id)); ?>"><i class="fa fa-pencil" style="margin-right: 5px;"></i>Edit</a>
                                            <?php endif; ?>
                                            <?php if(\App\Modals\User::hasSpecificPermission(\Illuminate\Support\Facades\Auth::user(),'company.delete')): ?>
                                                <a class="Rectangle-Delete btn-hover2" style="text-decoration: none;" href="<?php echo e(route('companys.destroy', $unit->id)); ?>"
                                                   onclick="deleteData('delete-form-<?php echo e($unit->id); ?>')"><i class="fa fa-trash"></i>
                                                    Delete
                                                </a>

                                                <form id="delete-form-<?php echo e($unit->id); ?>" action="<?php echo e(route('companys.destroy', $unit->id)); ?>" method="POST" class="d-none" style="display: none">
...
<?php /**PATH /home/bikroy/public_html/project_management_tool/resources/views/backend/companys/list.blade.php ENDPATH**/ ?>