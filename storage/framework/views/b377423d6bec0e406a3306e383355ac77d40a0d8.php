        ...
        <div class="main-panel role-edit-main-panel">
            <div class="content-wrapper">
                ...
                <div class="CreateRolekBox card-body">
                    <h5 class="mb-4 mt-2">Edit Department - <?php echo e($program->name); ?></h5>
                    <hr>
                    <div class="add-role-form">
                        <form action="<?php echo e(route('departments.update',$program->id)); ?>" method="POST">
...
<?php /**PATH C:\xampp\htdocs\project_management_tool\resources\views/backend/departments/edit.blade.php ENDPATH**/ ?>