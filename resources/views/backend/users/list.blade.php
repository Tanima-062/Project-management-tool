                    ...
                    <div class="row users-list-table-subHeader">
                        ...
                        <div class="col-sm-7 subHeader-col-2">
                            ...
                            <div style="display: inline-block;">
                                <a class="btn-hover" href="{{route('users.show.bulkUpload')}}"><button class="user-list-Bulk-Upload">Bulk Upload</button></a>
                            </div>
                            @if(\App\Modals\User::hasSpecificPermission(\Illuminate\Support\Facades\Auth::user(),'user.create'))
