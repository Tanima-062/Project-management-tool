    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel task-index-panel" >
            <div class="content-wrapper py-4">
                ...
                <form id="searchForm" method="POST" action="{{route('task.search')}}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <span class='right-inner-addon date datepicker'>
                                ...
                                <input name='start_date' value="{{date('d M, Y',strtotime($start_date))}}" type="text" data-date="" data-date-format="d M, yyyy" class="date-picker task-list-filter" placeholder="Start Time" autocomplete="off" id="start_date"/>
                            </span>
                    ...
                    <div>
                        <div class="form-inline row task-search-box m-0 py-3" style="border-bottom: 2px solid rgba(0, 0, 0, 0.1);">
                            ...
                            <div class="col-6 px-0" style="text-align: right;">
                                <a href="{{route('tasks.export')}}" class="task-export">
