        ...
        <div class="main-panel view-task-panel">
            <div class="content-wrapper">
                ...
                <div class="CreateTaskBox card-body">
                    <div>
                        @for($i= count($task_breadcums)-1; $i >= 0; $i--)
                            @if($i == 0)
                                <span>
                                  <a class="task-id-title" href="{{route('tasks.show',$task_breadcums[$i]['id'])}}">{{$task_breadcums[$i]['task_id']}}</a>
                                </span>
                            @else
                                <span>
                                    <a class="task-id-title" href="{{route('tasks.show',$task_breadcums[$i]['id'])}}">{{$task_breadcums[$i]['task_id']}}</a>
                    ...
                    <div class="row assign-by-assign-to-block">
                        <div class="col-md-6 pl-0">
                            ...
                            <div class="media" style="align-items: center;">
                                ...
                                @else
                                     <!-- <img class="profile-picture" src="{{asset('backend/uploads/profile_images/user-svgrepo-com.svg')}}" alt="profile" height="45px;" width="45px"/>    -->
                                ...
                                <div class="row date-row">
                                    <div class="col-6">
                                        <div class="task-element">
                                            ...
                                            <br>
                                            <i class="fa fa-clock"><span>{{$task->allocated_time}}</span></i>
                                        </div>
                                    </div>
                                </div>
                            @endif                           
                                                        ...
                                                        <div class="media" style="align-items: center;">
                                                            <div class="media-left">
                                                                @if(isset($assignee->userWithTrashed->image) && file_exists(public_path('backend/uploads/profile_images/'.$assignee->userWithTrashed->id.'/'.$assignee->userWithTrashed->image)))
                                                                    <img src="{!! URL::to('public/backend/uploads/profile_images/'.$assignee->userWithTrashed->id.'/'.$assignee->userWithTrashed->image) !!}" height="45" width="45" style="border-radius: 50%">
                                                                @else
                                                            ...
                                                            <div class="media-body" style="word-break:break-word;">&nbsp;&nbsp;{{empty($assignee->userWithTrashed->name) ? '' : $assignee->userWithTrashed->name}}{{empty($assignee->userWithTrashed->program) ? '' : ' ('.$assignee->userWithTrashed->program.')'}}</div>
                                                        </div>
                                                    </div>
                                                    <div class="col-3">
                            ...
                            <table class="table" id="task-table">
                                ...
                                @foreach($sub_tasks as $sub_task)
                                    <tr>
                                        ...
                                        <td class="pl-1">
                                            <a href="{{route('tasks.show',$sub_task->id)}}" style="color: #009877">{{empty($sub_task->title) ? '' : $sub_task->title.' (Sub-Task)'}}</a>
                                        </td>
                                        ...
                                        @if($sub_task->end_date < date('Y-m-d') && $sub_task->status < 2)
                                            <td>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <select class="progress-dropdown" name="task_status">
                                            ...
                                            <option value="5" {{($my_task_status == 5) ? 'selected' : ''}}>On Hold</option>
                                            <option value="6" {{($my_task_status == 6) ? 'selected' : ''}}>On Review</option>
                                        </select>
