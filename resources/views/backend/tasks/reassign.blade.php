        ...
        <div class="main-panel task-reassign-panel">
            <div class="content-wrapper">
                ...
                <div class="Task-reassign-title">Reassign</div>
                    <form method="POST" action="{{route('tasks.reassign.update',$task->id)}}" enctype="multipart/form-data" id="taskForm">
                        @csrf
                        ...
                        <div class="form-group task-description-group">
                            ...
                            <textarea class="form-control ckeditor" id="description" name="description" rows="3" disabled>{{$task->description}}</textarea>
                        ...
                        <div class="form-group row start-end-priority">
                            <div class="col-sm-4">
                                ...
                                <div class='right-inner-addon date datepicker'>
                                    ...
                                    <input name='start_date' value="{{date('d M, Y', strtotime($task->start_date))}}" type="text" class="form-control date-picker" id="start_date" autocomplete="off" readonly disabled/>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class='right-inner-addon date datepicker'>
                                    <i class="fa fa-calendar-o date-picker"></i>
                                    <input name='end_date' value="{{date('d M, Y', strtotime($task->end_date))}}" type="text" class="form-control date-picker" id="end_date" autocomplete="off" readonly disabled/>
                                </div>
                        ...
                        {{-- <div class="">
                            <label>Assign To <span class="mandatory">*</span></label><br>
                            <input type="hidden" id="task-assign-to" value="{{$task->assign_to}}">
                            <div class="radio-item">
                                <input type="radio" id="team" name="assign_to" value="team" {{($task->assign_to == 'team') ? 'checked' : ''}}>
                                <label for="team">Team</label>
                        ...
                        {{-- <div class="form-group row assign-to-block">
                            @if($task->assign_to == 'team')
                                <div class="col-sm-6 if-block-col-1 pr-4">
                                ...
                                <div class="col-sm-6 if-block-col-2 pl-4">
                            ...
                            @else
                                <div class="col-sm-6 else-block-col-1 pr-4">
                                    <label>Assign To Team(s)</label>
                                    <div class=" teamAssignToBox Task-Assign-To" >
                                        <div id="input_container">
                                            <input type="hidden" class="page_reassign_team" value="reassign_team">
                                ...
                                <div class="col-sm-6 else-block-col-2 pl-4">
                                    <label>Assign To Individual(s)</label>
                                    <div class="individualAssignToBox Task-Assign-To" >
                                        <div id="input_container">
                                            <input type="hidden" class="page_reassign_individual" value="reassign_individual">
