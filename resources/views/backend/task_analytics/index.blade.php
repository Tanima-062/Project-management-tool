                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-7 task_Status_date_filter">
                                ...
                                <span class='right-inner-addon date datepicker end-date-box' style="float:right;">
                                    ...
                                    <input name='end_date' value="{{date('d M, Y',strtotime($end_date))}}" type="text" data-date="" data-date-format="d M, yyyy" class="date-picker task-list-filter" placeholder="To" autocomplete="off" id="end_date"/>
                                ...
                                <span class='right-inner-addon date datepicker start-date-box' style="float:right;">
                                    <i class="fa fa-calendar-o"></i>
                                    <input name='start_date' value="{{date('d M, Y',strtotime($start_date))}}" type="text" data-date="" data-date-format="d M, yyyy" class="date-picker task-list-filter" placeholder="From" autocomplete="off" id="start_date"/>
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="col-md-4 text-right mb-2 pl-0">
                                <span class="error start_date-error" style="color:red;"></span>
                                <span class="error end_date-error" style="color:red;padding-right: 290px; "></span>
                            </div>
                        </div> --}}
                        {{-- task status card --}}
                        <div class="card analytics-task-status-crd top-section">
                            @include('backend.task_analytics.status_card')
                        </div>
                        {{-- task status card end--}}    
                    </div>
                    ...
                    <div class="col-md-12 my-5">
                        ...
                        <div style="margin-bottom:20px;">
                            <img src="{!! URL::to('public/backend/assets/img/info-icon.png')!!}" class="Info-Icon-Common"><small class="task-list-priority">PRIORITY</small>
                            ...
                            <div class="row DataTableBox">
                                <div class="row role-list-table-subHeader pr-0">
                                    ...
                                    <div class="col-sm-7 subHeader-col-2 pr-0">
                                        <a href="{{route('users.under.me.export')}}">
                                ...
                                <div class="user-table">
                                    @include('backend.task_analytics.user')
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 program-details text-center">
                        <div class="form-group m-0">
                            <h3>Department Wise Details</h3>
                            <select class="form-control select2" style="width: 15%;" id="program">
                               @foreach($programs as $key=>$program){
                                    @if($key==0)
                                        <option selected="selected" value="{{$program->id}}" class="selected_program">{{$program->name}}</option>
                                    @else
                    ...
                    <div class="col-md-12 program-wise-task-details">
                        <div class="Overdue-task-status-graph">
                            <div class="row show-chart">
                                @include('backend.task_analytics.chart')
                            </div>
                        </div>
                        <div class="mt-5 supervise-status">
                            @include('backend.task_analytics.supervise_status')
                        </div>
                    </div>
                </div>
            </div>
...
$("#reset").on("click", function(ev){
    ...
    $("#user_search").val("");
    $("#priority").val("");
    var start_date = ' <?php echo date('d M, Y', strtotime($start_date)); ?> ';
    var end_date = ' <?php echo date('d M, Y', strtotime($end_date)); ?> ';
