    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel role-list-main-panel">
            <div class="content-wrapper">
                ...
                <hr class="Dash-Line">
                <img src="{!! URL::to ('public/backend/assets/img/info-icon.png') !!}" class="Info-Icon-Common"><small class="task-list-priority">WEEK</small>
                ...
                <span class='right-inner-addon date datepicker'>
                    ...
                    <input name='start_date' value="{{date('d M, Y', strtotime($weeks[0]->start_date))}}" type="text" class="date-picker task-list-filter" placeholder="Start Time" autocomplete="off" id="start_date" readonly/>
                </span>
                <span class='right-inner-addon date datepicker'>
                    <i class="fa fa-calendar-o date-picker"></i>
                    <input name='end_date' value="{{date('d M, Y', strtotime($weeks[0]->end_date))}}" type="text" class="date-picker task-list-filter" placeholder="Due Time" autocomplete="off" id="end_date" readonly/>
                </span>
                <img src="{!! URL::to ('public/backend/assets/img/info-icon.png') !!}" class="Info-Icon-Common"><small class="task-list-priority">TEAM</small>
