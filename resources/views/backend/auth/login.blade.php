...
<head>
    ...
    <!-- Style -->
    <link rel="stylesheet" href="{!! URL::to ('public/backend/assets/css/login.css') !!}">
        ...
        <div class="container">
            ...
            <div class="row login-first-row">
                <div class="col-lg-6 left-item">
                    <img src="{!! URL::to('public/backend/assets/img/Login_Page_Vector_Graphics.png') !!}" class="Login-Page-Vector-Graphics img-fluid">
                </div>
                <div class="col-lg-4 col-sm-12 right-item">
                    <a href="{{route('login')}}">
                        <img src="{!! URL::to ('public/backend/assets/img/Bikroy-LogoTag.png') !!}" class="logo_brac img-fluid">
                    </a>
                    <div class="card">
                        <div class="card-body login-card-body">
                            ...
                            <form method="POST" action="{{ route('login.submit') }}">
                                ...
                                <div class="input-group mb-3">
                                    <img src="{!! URL::to ('public/backend/assets/img/stl_user_icon.png') !!}"
                                         class="User-Icon">
                                ...
                                <div class="input-group mb-3">
                                    <img src="{!! URL:: to('public/backend/assets/img/stl_password_icon.png') !!}"
                                         class="Password-Icon">
