...
<head>
    ...
    <link rel="stylesheet" href="{{asset('backend/assets/templates/vendors/bootstrap-datepicker/jquery-ui.css')}}">
    <link href="{{asset('backend/assets/templates/vendors/filepond/filepond.css')}}" rel="stylesheet">
</head>
<body>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.success == true) {
                                window.location = '/otherRequestTasks';
                            }
                        },
