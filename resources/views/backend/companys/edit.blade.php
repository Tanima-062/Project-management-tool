        ...
        <div class="main-panel role-edit-main-panel">
            <div class="content-wrapper">
                ...
                <div class="CreateRolekBox card-body">
                    <h5 class="mb-4 mt-2">Edit Company - {{$unit->name}}</h5>
                    <hr>
                    <div class="add-role-form">
                        <form action="{{route('companys.update',$unit->id)}}" method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-center">
                                    <a href="{{route('companys.index')}}" class="btn custom-outline-btn">Cancel</a>
