        ...
        <div class="main-panel role-edit-main-panel">
            <div class="content-wrapper">
                ...
                <div class="CreateRolekBox card-body">
                    <h5 class="mb-4 mt-2">Edit Role - {{$role->name}}</h5>
                    <hr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10" >
                                    <div class="radio-item">
                                        <input type="radio" id="status" name="status" value="1" {{($role->status == '1') ? 'checked' : ''}}>
                                        <label for="status">Active</label>
                                    </div>
                                    <div class="radio-item">
                                        <input type="radio" id="inactive" name="status" value="0" {{($role->status == '0') ? 'checked' : ''}}>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 form-check">
                                    <div class="form-check">
                                        <input type="checkbox" class="checkbox" id="checkPermissionAll" {{App\Modals\User::roleHasPermissions($role, $permissions) ? 'checked' : ''}}>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 form-check">
                                    ...
                                    @foreach($permission_groups as $group)
                                        @php $permissions = App\Modals\User::getPermissionsByGroupName($group->name); @endphp
                                        <div class="row">
                                                <div class="col-3 group-check">
                                                    <div class="form-check">
                                                        <input type="checkbox" class="checkbox" id="{{$i}}Management" value="{{$group->name}}" onclick="checkPermissionByGroup('role-{{$i}}-management-checkbox',this)" {{App\Modals\User::roleHasPermissions($role, $permissions) ? 'checked' : ''}}>
                                                ...
                                                <div class="col-9 role-group role-{{$i}}-management-checkbox">
                                                    ...
                                                    @foreach($permissions as $permission)
                                                        <div class="form-check">
                                                            <input type="checkbox" class="checkbox" name="permissions[]" id="checkPermission{{$permission->id}}" value="{{$permission->name}}" onclick="selectDeselectGroup('{{$i}}Management','role-{{$i}}-management-checkbox')" {{$role->hasPermissionTo($permission->name) ? 'checked' : ''}}>
